...
const NewComponentForm = () =>{
    useEffect(() => {
        ...
        $('#Comptype').select2({
          ...
          templateResult: formatState,  // Custom function for dropdown options
          templateSelection: formatState // Custom function for selected option
        });
      ...
      function formatState(state: any) {
        ...
        var $state = $();
        if (state.text==="Braking system") {

            return $(
              `<span className="Group-title"><img className="optgroup-image" style="width:32px; height:32px;" src="Images/Icons/Brakes.png" alt="Brakes" />${state.text}</span>`
            );

        }
        else if (state.text==="Engine-Cooling-system") {

            return $(
              `<span className="Group-title" ><img className="optgroup-image" style="width:32px; height:32px;" src="Images/Icons/water.png" alt="Water" />${state.text}</span>`
            );

        }
        else if (state.text==="Engine-oil-system") {
            return $(
              `<span className="Group-title" ><img className="optgroup-image" style="width:32px; height:32px;" src="Images/Icons/oil.png" alt="oil" /> ${state.text}</span>`
            );
        }
        else if (state.text==="Exhaust-system") {
            return $(
              `<span className="Group-title" ><img className="optgroup-image" style="width:32px; height:32px;" src="Images/Icons/breakdown.png" alt="breakdown" /> ${state.text}</span>`
            );
        }
        else{
            return $(
    ...
    <>
        <form>
            ...
            <br/>
            <a href="https://www.flaticon.com/authors/ddara" title="brake icons">icons created by dDara</a>
